...
func SetupOTelSDK(ctx context.Context) (shutdown func(context.Context) error, err error) {
	...
	if otelExporterOtlpEndpoint == "" {
		return nil, errors.New("OTEL_EXPORTER_OTLP_ENDPOINT environment variable is not set")
	}
...
func newLoggerProvider(ctx context.Context) (*otel_log.LoggerProvider, error) {
